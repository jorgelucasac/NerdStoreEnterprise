...
namespace Estudos.NSE.Carrinho.API.Migrations
{
    ...
    [Migration("20210602203545_CarrinhoCascade")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Estudos.NSE.Carrinho.API.Model.CarrinhoCliente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Estudos.NSE.Carrinho.API.Model.CarrinhoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Estudos.NSE.Carrinho.API.Model.CarrinhoCliente", b =>
                {
                    b.OwnsOne("Estudos.NSE.Carrinho.API.Model.Voucher", "Voucher", b1 =>
                        {
            ...
            modelBuilder.Entity("Estudos.NSE.Carrinho.API.Model.CarrinhoItem", b =>
                {
                    b.HasOne("Estudos.NSE.Carrinho.API.Model.CarrinhoCliente", "CarrinhoCliente")
                        .WithMany("Itens")
